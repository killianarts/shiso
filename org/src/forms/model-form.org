#+title: Model Form Generation
#+property: header-args:common-lisp :tangle ../../../src/forms/model-form.lisp
#+auto_tangle: t

Auto-generates form instances from model definitions, like Django's
=ModelForm=.  Reads field metadata from the model registry and maps each
slot to the appropriate form-field type.
...
Extends the base form with the model name for saving.
...
* Metadata to Form Field Mapping
