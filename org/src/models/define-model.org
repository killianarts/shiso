...
#+property: header-args:common-lisp :tangle ../../../src/models/define-model.lisp
#+auto_tangle: t
...
=define-model= splits each slot into its Mito portion and its metadata
portion, then expands into:
